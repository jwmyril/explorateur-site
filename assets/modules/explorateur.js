...
/* SANS NUMÉRO DE VERSION, ET C'EST OBLIGATOIRE.
   ...
   "./etat.js?v=37" et "./etat.js?v=37" sont deux modules distincts, chacun avec
   ...
   LES TROIS AUTRES — carte, comparaison, i18n — importaient "./etat.js?v=37" tout
...
(async function () {
  ...
  for (const m of ["i18n", "carte", "fiche", "recherche", "comparaison", "rapport"]) {
    (await import("./explorateur-" + m + ".js?v=37")).default(A);
  }
