...
const DV = "?d=2026-09-26b";   // doit suivre le DV de assets/modules/explorateur.js

const CORE = [
  "/", "/index.html", "/hors-connexion.html", "/manifest.webmanifest",
  "/assets/style.css?v=40", "/assets/data.css?v=53", "/assets/modules/explorateur.js?v=95",
  "/assets/modules/etat.js?v=39",
  "/assets/modules/explorateur-i18n.js?v=42",
  "/assets/modules/explorateur-carte.js?v=43",
  "/assets/modules/explorateur-fiche.js?v=43",
  "/assets/modules/explorateur-recherche.js?v=43",
  "/assets/modules/explorateur-comparaison.js?v=43",
...
const DATA = [
  ...
  "/couches.html", "/assets/couches.js?v=97",
]);
