...
const DV = "?d=2026-09-13a";   // doit suivre le DV de assets/modules/explorateur.js

const CORE = [
  "/", "/index.html", "/hors-connexion.html", "/manifest.webmanifest",
  "/assets/style.css?v=36", "/assets/data.css?v=52", "/assets/modules/explorateur.js?v=52",
  ...
  // qui cesse.
  "/couches.html", "/fiche.html", "/assets/couches.js?v=56",
