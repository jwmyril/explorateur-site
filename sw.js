...
const DV = "?d=2026-09-26a";   // doit suivre le DV de assets/modules/explorateur.js

const CORE = [
  "/", "/index.html", "/hors-connexion.html", "/manifest.webmanifest",
  "/assets/style.css?v=40", "/assets/data.css?v=53", "/assets/modules/explorateur.js?v=94",
...
const DATA = [
  ...
  "/couches.html", "/assets/couches.js?v=96",
]);
