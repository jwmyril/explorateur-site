...
const DV = "?d=2026-08-17a";   // doit suivre le DV de assets/modules/explorateur.js

const CORE = [
  "/", "/index.html", "/hors-connexion.html", "/manifest.webmanifest",
  "/assets/style.css?v=35", "/assets/data.css?v=40", "/assets/modules/explorateur.js?v=34",
  ...
  "/couches.html", "/fiche.html", "/assets/couches.js?v=27",
  "/assets/pwa.js?v=2",
