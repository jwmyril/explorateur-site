...
/* SANS NUMÉRO DE VERSION, ET C'EST OBLIGATOIRE.
   ...
   "./etat.js?v=38" et "./etat.js?v=38" sont deux modules distincts, chacun avec
   ...
   LES TROIS AUTRES — carte, comparaison, i18n — importaient "./etat.js?v=38" tout
...
(async function () {
  ...
  for (const m of ["i18n", "carte", "fiche", "recherche", "comparaison", "rapport"]) {
    (await import("./explorateur-" + m + ".js?v=38")).default(A);
  }
